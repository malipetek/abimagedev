...
var l$1="global",o$1=j$1+"global"+j$1,n=typeof self===o$2&&self.self===self&&self||typeof global===o$2&&global.global===global&&global||void 0;function a$4(t){return n[o$1][t]}function f$1(t,e){return n[o$1][t]=e}function i$4(t){delete n[o$1][t];}function u$3(t,e,r){var l;try{if(b$2(t)){var o=window[t];l=o[e].bind(o);}}catch(t){}return l||r}n[o$1]||(n[o$1]={});var c$3={};function b$2(t){if(typeof c$3[t]!==e$2)return c$3[t];try{var e=window[t];e.setItem(e$2,e$2),e.removeItem(e$2);}catch(e){return c$3[t]=!1}return c$3[t]=!0}
...
function AbimageProvider(userConfig) {
